...
import 'package:nubanktest/infra/http/http.dart';
...
void main() {
  ...
  group('shared', () {
    test('Should throw ServerHerror if invalid method is provided', () async {
  ...
  group('post', () {
    When mockRequest() => when(() => client.post(myUri,
    ...
    test('Should call post without body', () async {
      ...
      verify(() => client.post(myUri, headers: any(named: 'headers')));
    });
    ...
    test('Should return ServerError if post throws Exception', () async {
      mockError();
      final future = sut.request(url: url, method: 'post');
  ...
  group('get', () {
    When mockRequest() =>
        when(() => client.get(myUri, headers: any(named: 'headers')));
    ...
    test('Should call get with correct values', () async {
      ...
      verify(() => client.get(myUri, headers: {
            'content-type': 'application/json',
            'accept': 'application/json'
          }));
    });
    ...
    test('Should return ServerError if get throws Exception', () async {
      mockError();
      final future = sut.request(url: url, method: 'get');
